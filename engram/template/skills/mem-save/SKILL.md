...
**Gotcha** — dated bullet at the TOP of `gotchas.md` (newest first): `- **YYYY-MM-DD** — what bites, where, and the rule to follow.` Cross-cutting traps only; module-specific traps go in that module's atlas card.
